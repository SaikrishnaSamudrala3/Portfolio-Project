  ...
  return (
    ...
    className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6'>
      {workData.map((project, index)=>(
        ...
        relative cursor-pointer group shadow-lg h-48 sm:h-64 md:h-72 lg:h-80'
    ...
    href="https://github.com/SaikrishnaSamudrala3" target='_blank' className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px]
