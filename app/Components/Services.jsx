  ...
  return (
    ...
    id="services" className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-serif '>
        I am full stack web developer from Tempe, USA with hands on experience in auidting websites and Quality Assurance.
        </motion.p>
        ...
        className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-10'>
            {serviceData.map(({icon, title, description, link}, index)=>(
                ...
                key={index}
                    className='border border-gray-400 rounded-lg px-8 py-12 hover:shadow-amber-500
                    cursor-pointer hover:bg-blue-300 hover:-translate-y-1 duration-500'>
